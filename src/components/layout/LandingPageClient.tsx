    ...
    return (
        <>
            ...
            <div className="min-h-screen">
                    ...
                    <div className="container relative px-4 py-24 mx-auto max-w-7xl">
                        <div className="flex flex-col items-center text-center space-y-8">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 mt-8">
                                <Button
                                    size="lg"
                                    className="gap-2 text-lg px-8 hover-elevate transition-smooth"
                                    onClick={() => {
                                ...
                                <Button
                                    variant="outline"
                                    size="lg"
                                    className="text-lg px-8 hover-elevate transition-smooth"
                                    onClick={() => {
                ...
                {/* Modules Preview */}
                <div className="container px-4 py-24 mx-auto max-w-7xl bg-muted/30 rounded-3xl backdrop-blur-md border border-white/5">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                    ...
                    <div className="text-center mt-12">
                        <Button
                            size="lg"
                            className="gap-2 transition-smooth hover-elevate"
                            onClick={() => {
                                useUIStore.getState().setAuthModalMode('signup')
                                useUIStore.getState().setAuthModalOpen(true)
                            }}
